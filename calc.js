...
function buildInstances(){
    ...
    for(var i=0; i<instances;i++) {
        var inst="bucket"+ i;
        instanceHTML += '<table class="main" id="' + inst + '"> <tr> <td valign="top"> <table class="bucket"> <tr> <td><h1> BUCKET:'+ (i+1) + '</h1></td></tr><tr> <td><div id="' + inst + 'sliderCores"></div></td><td><div id="' + inst + 'sliderRam"></div></td></tr><tr> <td>Cores: <input id="' + inst + 'sliderCores-value" size="4"> </td><td>RAM: <input id="' + inst + 'sliderRam-value" size="4"> </td></tr><tr> <td></td><td><div id="' + inst + 'sliderXDCR"></div></td></tr><tr> <td></td><td>XDCR: <span id="' + inst + 'sliderXDCR-value"></span></td></tr><tr> <td><div id="' + inst + 'sliderReplica"></div></td><td><div id="' + inst + 'sliderPerc"></div></td></tr><tr> <td>Replicas: <span id="' + inst + 'sliderReplica-value"></span></td><td>Working Set Percentage: <span id="' + inst + 'sliderPerc-value"></span>%</td></tr><tr> <td colspan="2" class="dropdown"> <table> <tr> <td><h1>Storage:</h1></td><td><h1>Ver:</h1></td><td><h1>Views?</h1></td><td id="' + inst + 'tdThreadSlider"><div id="' + inst + 'sliderThread"></div></td></td><td id="' + inst + 'tdTunableHeader"><h1>Eviction:</h1></td></tr><tr> <td> <select id="' + inst + 'selDrives"> <option value="3500">HDD</option> <option value="10000">SSD</option> <option value="20000">SSD (ENT)</option> <option value="1500">EBS (AMZ)</option> <option value="5000">IOPS (AMZ)</option> </select></td><td> <select id="' + inst + 'selVersion"> <option value="2">2.XX</option> <option value="3">3.XX</option> </select></td><td> <select id="' + inst + 'selView"> <option value="0">NO</option> <option value="1">YES</option> </select></td><td id="' + inst + 'tdThreadHeader">Thread Pool (%): <input id="' + inst + 'sliderThread-value" size="3"> </td><td id="' + inst + 'tdTunableSelect"> <select id="' + inst + 'selEviction"> <option value="0">Value</option> <option value="1">Full</option> </select></td></tr></table></td></tr></table> <p> <div class="classTable docs"> <table> <tr> <td colspan="2">Document Size Info</td></tr><tr> <td>Key Size (in Bytes):</td><td> <input type="text" id="' + inst + 'keySize" value="40"/> </td></tr><tr> <td>Value Size (in Bytes):</td><td> <input type="text" id="' + inst + 'valSize" value="5120"> </td></tr><tr> <td>Total Number of Documents:</td><td> <input type="text" id="' + inst + 'valDocs" value="1000000"> </td></tr></table> <table> <tr> <td colspan="2 ">Operations Per Second</td></tr><tr> <td>Sustained Read Rate (ops/sec):</td><td> <input type="text" id="' + inst + 'rateRead" value="1000"> </td></tr><tr> <td>Sustained Write Rate (ops/sec):</td><td> <input type="text" id="' + inst + 'rateWrite" value="1000"> </td></tr><tr> <td>Sustained Deletions (ops/sec):</td><td> <input type="text" id="' + inst + 'rateDelete" value="1000"> </td></tr></table> <table id="' + inst + 'tableView"> </tr><td colspan="2">Views</td></tr><tr> <td>Number of Views</td><td> <input type="text" id="' + inst + 'viewNum" value="0"> </td></tr><tr> <td>% of Docs Matching</td><td> <input type="text" id="' + inst + 'viewMatch" value="10"> </td></tr><tr> <td>Size of info that matches (%)</td><td> <input type="text" id="' + inst + 'viewSize" value="10"> </td></tr><tr> <td>Rows per Match</td><td> <input type="text" id="' + inst + 'viewRows" value="1"> </td></tr></table> </div></td><td valign="top"> <div class="classTableOutput"> <table> <tr> <td colspan="2">Bucket ' + (parseInt(i)+1)+' Outputs</td></tr><tr> <td>Memory Bound Nodes:</td><td class="highlight"><label id="' + inst + 'lblMemBound"/></td></tr><tr> <td>Total Memory Used:</td><td><label id="' + inst + 'lblMemPerNode"/></td></tr><tr> <td>Disk Bound Nodes:</td><td class="highlight"><label id="' + inst + 'lblDiskBound"/></td></tr><tr> <td>Total Disk Space Used:</td><td><label id="' + inst + 'lblTotalDisk"/></td></tr></table> </div><br><div id="' + inst + 'tableConstants" class="classTableConstants"> <table> <tr> <td valign="bottom"> <form id="' + inst + 'lockForm" action=""> <input type="radio" id="' + inst + 'radio1" name="group1" value="locked" checked> <label for="radio1">lock</label> <input type="radio" id="' + inst + 'radio2" name="group1" value="unlocked"> <label for="radio2">unlock</label> </form></td><td>Constants</td></tr><tr> <td>Compaction Threshold:</td><td> <input type="text" id="' + inst + 'compactionThresholdConstant" value=".05" readonly> </td></tr><tr> <td>Background Fetch Threshold:</td><td> <input type="text" id="' + inst + 'backgroundThresholdConstant" value=".05" readonly> </td></tr><tr> <td>Background Fetch XDCR:</td><td> <input type="text" id="' + inst + 'backgroundThresholdXDCR" value=".05" readonly> </td></tr><tr> <td>Meta Data:</td><td> <input type="text" id="' + inst + 'metaDataConstant" value="56" readonly> </td></tr><tr> <td>OS Headroom:</td><td> <input type="text" id="' + inst + 'osHeadroomConstant" value=".20" readonly> </td></tr><tr> <td>Couchbase High Memory Watermark:</td><td> <input type="text" id="' + inst + 'highMemConstant" value=".85" readonly> </td></tr><tr> <td>Ammend Multiplier:</td><td> <input type="text" id="' + inst + 'amendMultiplierConstant" value="3" readonly> </td></tr><tr> <td>Fragment Multiplier:</td><td> <input type="text" id="' + inst + 'fragmentMultiplierConstant" value="1" readonly> </td></tr></table> </div></td></tr></table>'
    }
